...
<main>
    ...
    <section class="contenedor contenedor-inicio-conoceme">
        <div class="conoceme-inicio-video">
            <video src="src/video/conocemeVideo.mp4" autoplay muted controls preload loading="lazy"></video>
        </div>
        <div class="conoceme-inicio-texto">
